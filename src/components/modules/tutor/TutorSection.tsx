...
const TutorSectionDetails = async ({ id }: { id: string }) => {
    ...
    if (!result) {
        return <p className="text-center text-gray-500">Tutor details not found.</p>;
    }

    const { image, bio, experience, isVerified, rates, ratings, subjects } = result.data;
        ...
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div>
                    ...
                    {isVerified && (
                        <span className="text-green-600 font-semibold">✔ Verified Tutor</span>
                    )}
                </div>
            </div>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
                ...
                <div className="p-4 bg-gray-100 rounded-lg">
                    ...
                    <p className="text-gray-700">{subjects?.join(", ") || "Not specified"}</p>
                </div>
            </div>
        </div>
    );
