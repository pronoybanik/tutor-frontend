          ...
          <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Learn lorem ipsum dolor sit amet consectetur. Montes quisque
                arcu malesuada tristique at. Lorem ipsum dolor sit amet
            ...
            {Array.from({ length: 4 }).map((_, idx) => (
              ...
              >
                ...
                <p className="text-gray-600 text-center">
                  Learn from skilled and certified instructors who are experts
                  in immersive learning techniques.
                </p>
              </div>
            ))}
          </div>
